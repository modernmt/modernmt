...
set(FastAlign_SEARCH_HEADER_PATHS ${CMAKE_SOURCE_DIR}/../../fastalign-aligner/native/include)

set(FastAlign_SEARCH_LIB_PATH ${CMAKE_SOURCE_DIR}/../../fastalign-aligner/target/native/)

find_path(FastAlign_INCLUDE_DIR fastalign/FastAligner.h PATHS ${FastAlign_SEARCH_HEADER_PATHS})
...
if (FastAlign_FOUND)
    message(STATUS "Found the FastAlign library: ${FastAlign_LIBS} ${FastAlign_INCLUDE_DIR}")
else ()
