...
//        assertEquals(4, analyzer.getStorage().size());
//
...
//        assertEquals(2, analyzer.getStorage().size());
//        assertEquals(TestData.channels(20L, 0L), analyzer.getStorage().getLatestChannelPositions());
...
//        assertEquals(6, analyzer.getStorage().size());
//
//        analyzer.onDelete(TestData.deletion(1));
//
//        TLuceneAnalyzer.Entry entry = analyzer.getEntry(2, EN__IT);
...
//        assertEquals(2, analyzer.getIndexSize());
//        assertEquals(2, analyzer.getStorage().size());
//        assertEquals(TestData.channels(30L, 0L), analyzer.getStorage().getLatestChannelPositions());
//        assertEquals(TestData.getTerms(EN), entry.terms);
//        assertEquals(TestData.getContent(EN), entry.content);
//        assertNull(analyzer.getEntry(1, EN__IT));
...
//        assertEquals(0, analyzer.getStorage().size());
//        assertEquals(TestData.channels(20L, 1L), analyzer.getStorage().getLatestChannelPositions());
//        assertNull(analyzer.getEntry(1, EN__IT));
...
//        assertEquals(2, analyzer.getIndexSize());
//        assertEquals(2, analyzer.getStorage().size());
//        assertEquals(19, (long) analyzer.getStorage().getLatestChannelPositions().get((short) 0));
//        assertEquals(0, (long) analyzer.getStorage().getLatestChannelPositions().get((short) 1));
...
//        assertEquals(4, analyzer.getIndexSize());
//        assertEquals(4, analyzer.getStorage().size());
//        assertEquals(TestData.channels(1, 19), analyzer.getStorage().getLatestChannelPositions());
