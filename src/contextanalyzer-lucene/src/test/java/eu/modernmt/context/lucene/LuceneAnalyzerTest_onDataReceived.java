...
//        assertEquals(expectedChannels, analyzer.getStorage().getLatestChannelPositions());
...
//        assertEquals(8, analyzer.getStorage().size());
//        assertEquals(expectedChannels, analyzer.getStorage().getLatestChannelPositions());
//
...
//        assertEquals(2, analyzer.getIndexSize());
//        assertEquals(2, analyzer.getStorage().size());
//        assertEquals(TestData.channels(10L, 3L), analyzer.getStorage().getLatestChannelPositions());
