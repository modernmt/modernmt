...
#ifndef ROCKSLM_ADAPTIVELMCACHE_H
#define ROCKSLM_ADAPTIVELMCACHE_H
...
namespace rockslm {
    ...
    public:
        ...
        inline void Put(const db::dbkey_t key, const cachevalue_t &value) {
            cache[key] = value;
        }

        // lookup in the cache the entry key(word, state), if found, fill the given parameters
        // and return true, else return false
        inline bool Get(const db::dbkey_t key, cachevalue_t *outValue) {
...
#endif //ROCKSLM_ADAPTIVELMCACHE_H
