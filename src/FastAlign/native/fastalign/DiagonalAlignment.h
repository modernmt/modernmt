...
#ifndef FASTALIGN_DIAGONALALIGNMENT_H
#define FASTALIGN_DIAGONALALIGNMENT_H
...
struct DiagonalAlignment {
    ...
    static double
    UnnormalizedProb(const unsigned i, const unsigned j, const unsigned m, const unsigned n, const double alpha) {
...
private:
    ...
    arithmetico_geometric_series(const double a_1, const double g_1, const double r, const double d, const unsigned n) {
...
#endif //FASTALIGN_DIAGONALALIGNMENT_H
