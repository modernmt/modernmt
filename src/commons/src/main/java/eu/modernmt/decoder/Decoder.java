...
public abstract class Decoder implements Closeable {
    ...
    public abstract Translation translate(long user, LanguagePair direction, Sentence text) throws DecoderException;

    public abstract Translation translate(long user, LanguagePair direction, Sentence text, ContextVector contextVector) throws DecoderException;
