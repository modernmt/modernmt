...
public class Symmetrization {
    private static final Logger logger = LogManager.getLogger(Symmetrization.class);
    ...
    /**
     * Symmetrization method which produces, as a result, the intersection of the
    ...
    /**
     * Symmetrization method which produces, as a result, the union of the
     *
     * @param s2t Source to target asymmetric alignment produced with GIZA++
     * @param t2s Target to source asymmetric alignment produced with GIZA++
     * @return
...
*/
    ...
    static public int[][] symmetriseGizaFormatAlignment(String sl_sent_s2t, String alg_info_s2t, String sl_sent_t2s, String alg_info_t2s, Strategy strategy) {
        ...
        switch (strategy) {
            case Union:
                al = Symmetrization.UnionSymal(s2talignment, t2salignment);
                break;
            case Intersection:
                al = Symmetrization.IntersectionSymal(s2talignment, t2salignment);
                break;
    ...
    static public int[][] symmetrizeAlignment(int[][] sl, int[][] tl, Strategy strategy) {
