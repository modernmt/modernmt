...
// */
//public class MMTServer extends Cluster<ServerStatus> {
//
//    public static final int[] DEFAULT_SERVER_PORTS = {5000, 5001, 5002, 5003};
//
...
//        super(new ZMQMessagingServer(ports));
//        this.engine = engine;
//        this.sessions = new HashMap<>();
//        this.status = new ServerStatus();
//        this.status.decoderWeights = engine.getDecoderWeights();
//    }
//
//    @Override
//    protected ServerStatus getCurrentStatus() {
//        return status;
//    }
//
//    // =============================
