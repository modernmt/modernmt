...
public class Symmetrisation {
    ...
    static public String symmetriseMosesFormatAlignment(String sl_line, String tl_line, Type type){
        ...
        //Producing the symmetrised alignment
        switch(type){
            case Union: al=Symmetrisation.UnionSymal(s2talignment,t2salignment); break;
            case Intersection: al=Symmetrisation.IntersectionSymal(s2talignment,t2salignment); break;
            case GrowDiagFinalAnd: al=Symmetrisation.GrowDiagFinalAnd(s2talignment,t2salignment); break;
        }
