...
public class _Token implements Serializable {
    ...
    public _Token(String placeholder) {
        this(null, placeholder, null);
    }

    public _Token(String placeholder, String rightSpace) {
        this(null, placeholder, rightSpace);
    }

    public _Token(String text, String placeholder, String rightSpace) {
        this.text = text;
