...
public class UUIDSequence {
    ...
    public static synchronized UUIDSequence getSequence(short sequenceId) {
        return sequences.computeIfAbsent(sequenceId, integer -> new UUIDSequence(sequenceId));
    }

    private final short id;
    private int sequence;

    private UUIDSequence(short id) {
        this.id = id;
        this.sequence = 0;
    }
