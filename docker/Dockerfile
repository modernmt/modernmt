...
# ===================================================================================================
FROM nvidia/cuda:10.0-cudnn7-runtime-ubuntu18.04 AS modernmt-base
...
# Cleanup and pack
RUN find . -name ".?*" | xargs rm -rf &> /dev/null && rm -rf setup.py requirements.txt src test build/include && \
